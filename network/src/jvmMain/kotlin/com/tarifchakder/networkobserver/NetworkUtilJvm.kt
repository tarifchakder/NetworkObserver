        ...
        return withContext(Dispatchers.IO) {
            ...
            while (networkInterfaces.hasMoreElements()) {
                ...
                if (networkInterface.isUp && !networkInterface.isLoopback) {
                    ...
                    when {
                        displayName.contains("wi-fi") || displayName.contains("wifi") || name.contains(
                            "wlan"
                        ) || name.contains("wlp") -> {
                            return@withContext NetworkType.WIFI
                        }

                        name.contains("eth") || name.contains("enp") || name.contains("eno") || (name.startsWith(
                            "en"
                        ...
                        name.contains("mobile") || name.contains("cellular") || name.contains("ppp") || name.contains(
                            "rmnet"
                        ) -> {
